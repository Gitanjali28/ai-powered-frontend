    ...
    <div className="min-h-screen bg-[#f3f3f3] flex flex-col font-sans">
      ...
      <div className="flex-1 px-6 py-20">
        ...
        <div className="text-center mb-28">
          ...
          {/* 🟢 NEW START INTERVIEW BUTTON ADDED HERE 🟢 */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <button
              ...
              className="px-10 py-4 bg-green-500 hover:bg-green-600 text-white font-bold text-xl rounded-full shadow-xl transition-all duration-300 transform hover:scale-105"
            >
              Start Interview Now
            </button>
          </motion.div>
